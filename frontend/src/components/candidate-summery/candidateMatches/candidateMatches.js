import CandidateMatchesCard from "./components/candidateMatchesCard";

const CandidateMatches = ({ processes, processLoading, processError }) => {
  return (
    <div>
      ...
      {processes &&
        !processLoading &&
        processes?.map((process) => <CandidateMatchesCard process={process} />)}
