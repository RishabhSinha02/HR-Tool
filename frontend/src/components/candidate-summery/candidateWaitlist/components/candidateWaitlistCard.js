...
const CandidateWaitlistCard = ({ process }) => {
      ...
      >
        <div className="text-xl font-medium flex items-center justify-between">
          ...
          >
            <div>
              <div
                className="card rounded-3xl px-4 mx-3"
              ...
              <div
                className="card rounded-3xl px-4 m-3"
                style={{ backgroundColor: "#FFA2A2" }}
              >
                <div className="flex items-center">
                  <svg
                    width="10"
        ...
        {isOpen && (
          <div className="mt-4" style={{ fontSize: "13px" }}>
            ...
            <div className="my-2">
              ...
              <p>
                Rishabh was selected due to 5 years of experience in Python and
...
export default CandidateWaitlistCard;
